...
void	img_path(t_graph *data)
{
	...
	data->wall = mlx_xpm_file_to_image(data->mlx, "assets/images/wall.xpm", &w,
			&w);
	data->coin = mlx_xpm_file_to_image(data->mlx, "assets/images/coin-bag.xpm",
			&w, &w);
	data->closed_exit = mlx_xpm_file_to_image(data->mlx,
			"assets/images/exit-closed.xpm", &w, &w);
	data->open_exit = mlx_xpm_file_to_image(data->mlx,
			"assets/images/open-exit.xpm", &w, &w);
	...
	data->p_right = mlx_xpm_file_to_image(data->mlx,
			"assets/images/player/right.xpm", &w, &w);
	data->p_top = mlx_xpm_file_to_image(data->mlx,
			"assets/images/player/back.xpm", &w, &w);
	data->dead = mlx_xpm_file_to_image(data->mlx, "assets/images/game-over.xpm",
			&w, &w);
}
...
int	imgadd(t_graph *data, int x, int y, int base)
{
	if (base == '1')
		...
		mlx_put_image_to_window(data->mlx, data->mlx_win, data->closed_exit, x,
			y);
	else if (base == 'O')
